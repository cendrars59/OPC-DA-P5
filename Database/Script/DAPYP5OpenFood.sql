...
-- -----------------------------------------------------
-- Table `OpenFoodsDB`.`User`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OpenFoodsDB`.`User` ;

CREATE TABLE IF NOT EXISTS `OpenFoodsDB`.`User` (
...
-- -----------------------------------------------------
-- Table `OpenFoodsDB`.`User Search`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OpenFoodsDB`.`User Search` ;

CREATE TABLE IF NOT EXISTS `OpenFoodsDB`.`User Search` (
  ...
  CONSTRAINT `fk_Product_has_Category_User1`
    ...
    REFERENCES `OpenFoodsDB`.`User` (`idUser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
