...
-- -----------------------------------------------------
-- Table `opc_p5_db`.`User_Search`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `opc_p5_db`.`User_Search` ;

CREATE TABLE IF NOT EXISTS `opc_p5_db`.`User_Search` (
  ...
  UNIQUE INDEX `idSearch_UNIQUE` (`idSearch` ASC) VISIBLE,
